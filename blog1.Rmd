...
# Example 1: Snowshoe Hare Exploratory Report
...
**I. The Total Number of Juvenile Hare Trappings by Year**
...
**Figure 1.** The total number of trapped juvenile snowshoe hares at the three BCEF, long-term ecological research sites, between 1998 and 2012 *(Source: Kielland et al. 2017)*.
...
**Figure 2.** Recorded juvenile snowshoe hare weights by sex and site at the three BCEF, long-term ecological research sites, between 1998 and 2012. "NA" relates to those observations in which sex was not recorded. Included, are mean values and errorbars in black *(Source: Kielland et al. 2017)*.

**Figure 2** shows that juvenile hares remain in a weight range of approximately 200 to 1,700 grams, where the mean weights between sex and across the three long-term ecological research sites show notable characteristics. Male hares tend to maintain a higher average weight than that of female hares. In total, throughout the 1998 to 2012 data accumulation period, more hares were trapped along the riparian site and more female hares were trapped along the lowland site. Though with reference to the lack of consistent hare trapping that was inferred from **Figure 1**, it is unlikely that these characteristics are representative of the distribution of the different juvenile hare sexes along these three sites.

**III. The Weight Statistics by Sex for Juvenile Hares**

**Table 1.** The weight mean, median, standard deviation, and total observation count for trapped female and male juvenile hares across all sites and years *(Source: Kielland et al. 2017)*.
...
In reference to **Table 1**, a two-sample t-test and a Cohen's *d* are calculated to derive a holistic view of the difference in weights between male and female juvenile hares within the three BCEF sites. The actual difference in weight means between the sexes is 90.5 grams. With a p-value of 0.007, there is a 0.7% probability that the two sample means were of the same population; meaning, there was more evidence of a significant difference between population means and they were likely drawn from "different" populations. Cohen's *d* is calculated at -0.29, demonstrating a narrow margin of standard deviation where distributed observations tend to be closer to the sample mean.

**IV. The Relationship Between Juvenile Hare Weight and Hind Foot Length**
...
**Figure 3.** The relationship between juvenile hare hind foot length and weight, regardless of sex, across the three BCEF, long-term ecological research sites, between 1998 and 2012 *(Source: Kielland et al. 2017)*.
...
Kielland, K., Chapin, F.S., Ruess, R.W., & Bonanza Creek LTER. (2017). Snowshoe hare physical data in Bonanza Creek Experimental Forest: 1999-present (Version 22). Environmental Data Initiative.
